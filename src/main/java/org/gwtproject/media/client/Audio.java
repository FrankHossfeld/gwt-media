...
public class Audio extends MediaBase {
  ...
  private static class AudioElementSupportDetectorFactory {

    public static Audio.AudioElementSupportDetector create(){
      if("maybe".equals(System.getProperty("audioElementSupport"))){
        return new AudioElementSupportDetectedMaybe();
      }

      if("no".equals(System.getProperty("audioElementSupport"))){
        return new AudioElementSupportDetectedNo();
      }
  ...
  public static Audio createIfSupported() {
    if (detector == null) {
      detector = AudioElementSupportDetectorFactory.create();
    }
